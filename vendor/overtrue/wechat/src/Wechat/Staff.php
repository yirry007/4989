...
class Staff
{
    ...
    const API_BIND = 'https://api.weixin.qq.com/customservice/kfaccount/inviteworker'; //新增 2018-03-20
    const API_MESSAGE_SEND = 'https://api.weixin.qq.com/cgi-bin/message/custom/send';
    const API_AVATAR_UPLOAD = 'https://api.weixin.qq.com/customservice/kfaccount/uploadheadimg'; //修改 2018-03-20
     ...
     *
     * @param string $email
     * @param string $invite_wx
     *
     * @return bool
     */
    public function bind($email, $invite_wx)
    {
        $params = array(
            'kf_account' => $email,
            'invite_wx' => $invite_wx,
        ...
        return $this->http->jsonPost(self::API_BIND, $params);
    }
