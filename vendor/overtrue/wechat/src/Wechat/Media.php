...
class Media
{
    ...
    const API_NEWSIMAGE_UPLOAD = 'https://api.weixin.qq.com/cgi-bin/media/uploadimg'; //新增 2018-03-14
    ...
    protected function upload($type, $path, $params = array())
    {
        ...
        if ($type == 'image' || $type == 'newsImage') { //修改 2018-03-14
            return $response;
        }
    ...
    protected function getUrl($type, $queries = array())
    {
        ...
        } elseif ($type === 'newsImage') { //新增 2018-03-14
            $api = self::API_NEWSIMAGE_UPLOAD;
        } else {
