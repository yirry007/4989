        ...
        <form action="<?php echo e(url('weixin/reply_add')); ?>" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="msg">
                    </td>
                </tr>
                <tr>
                    <th width="160"><i class="require">*</i>消息类型：</th>
                    <td class="event_type">
                        <label><input type="radio" name="event_type" value="0" />呼叫客服</label>
                ...
                <tr>
                    <th>素材ID：</th>
                    <td>
                        <textarea name="event_value" style="height:200px;" placeholder="消息类型为文本则直接输入回复文字，否则输入素材ID"></textarea>
                    </td>
                </tr>
                <tr>
                    <th>选择素材：</th>
