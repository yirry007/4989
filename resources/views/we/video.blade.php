...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="<?php echo e(url('weixin')); ?>">首页</a> &raquo; <a href="javascript:void(0);">素材管理</a> &raquo; 视频素材
    </div>
    <!--面包屑导航 结束-->

    <!--搜索结果页面 列表 开始-->
    <form action="<?php echo e(url('weixin/video_add')); ?>" method="post">
        <div class="result_wrap">
            <!--快捷导航 开始-->
            <div class="result_content">
                <div class="short_wrap">
                    <a href="<?php echo e(url('weixin/video_add')); ?>"><i class="fa fa-plus"></i>新增视频</a>
                </div>
            </div>
            <!--快捷导航 结束-->
        </div>
