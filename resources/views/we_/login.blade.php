...
<link href="<?php echo e(asset('/we/login/css/login.css')); ?>" type="text/css" rel="stylesheet">
</head> 
<body> 
...
<div class="login">
    ...
    <form method="post" action="<?php echo e(url('/weixin/login')); ?>">
		...
		<img src="<?php echo e(url('/weixin/code')); ?>" onclick="this.src='<?php echo e(url('/weixin/code')); ?>?'+Math.random();"/>
		<hr class="hr15" />
