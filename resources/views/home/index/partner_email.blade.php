...
<div class="line"></div>
<h4>Benefit Rate：<?php echo e($emailData['orderData']->rate); ?>%</h4>
<h4>Benefit Amount：￥<?php echo e(number_format($emailData['orderData']->rate*$emailData['orderData']->all_price/100, 2, '.', '')); ?>元</h4>