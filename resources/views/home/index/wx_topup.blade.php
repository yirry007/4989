...
@section('content')
    <div class="contaner">
        <div class="view-tit"><p>Balance</p>Confirm Amount</div>
        <div class="view-con">
            <div class="clearfix">
                <p>Amount</p>
                <p>￥<?php echo e($topupData->money); ?></p>
            </div>
            <div class="clearfix">
                <p>Serial</p>
                <p><?php echo e($topupData->topup_sn); ?></p>
            </div>
            <div class="clearfix">
                <p>Payee</p>
                <p>Wechat Pay</p>
        ...
        <div class="view-bt"><a href="javascript:void(0);" onclick="callpay();">Payment</a><a href="<?php echo e(url('/topup')); ?>">Cancel</a></div>
    </div>
@endsection
