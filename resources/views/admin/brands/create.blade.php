...
@section('content')
<div class="pd-20">
  <form action="<?php echo e(url('/admin/brands')); ?>" method="post" class="form form-horizontal" id="form-member-add">
    ...
    <div class="row cl">
	  ...
	  <div class="row cl">
		  ...
		  <div class="formControls col-6">
			  <input type="text" class="input-text" value="<?php echo e(session('input')['image']); ?>" placeholder="" id="" name="image">
		  </div>
	  ...
	  <div class="row cl">
		  ...
		  <div class="formControls col-6">
              <img src="<?php echo e(url('public/'.session('input')['image'] ? session('input')['image'] : $system->sys_value)); ?>" width="100" id="image_preview" />
		  </div>
	  </div>
      <div class="row cl">
      ...
      <div class="row cl">
          ...
          <div class="formControls col-6 skin-minimal">
              <div class="radio-box">
                  <input type="radio" name="is_korea" value="1" <?php if(session('input')['is_korea'] === '1') echo 'checked'; ?>>
                  <label>Enable</label>
              </div>
              <div class="radio-box">
                  <input type="radio" name="is_korea" value="0" <?php if(session('input')['is_korea'] === '0' || session('input')['is_korea'] === NULL) echo 'checked'; ?>>
                  <label>Disable</label>
              </div>
          </div>
      </div>
