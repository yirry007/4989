...
<div class="pd-20">
  <form action="<?php echo e(url('/admin/articles/'.$field->id)); ?>" method="post" class="form form-horizontal">
      ...
      <div class="row cl">
          ...
          <div class="formControls col-6">
              <input type="text" class="input-text" value="<?php echo e($field->author); ?>" placeholder="" name="author" >
          </div>
          <div class="col-3"></div>
      </div>
      <div class="row cl">
          ...
          <div class="formControls col-6 skin-minimal">
              <div class="radio-box">
                  <input type="radio" name="sharing" value="1" <?php if($field->sharing == 1) echo 'checked'; ?>>
                  <label>Enable</label>
              </div>
              <div class="radio-box">
                  <input type="radio" name="sharing" value="0" <?php if($field->sharing == 0) echo 'checked'; ?>>
                  <label>Disable</label>
              </div>
          </div>
      </div>
      <div class="row cl">
          ...
          <div class="formControls col-6 skin-minimal">
              <div class="radio-box">
                  <input type="radio" name="following" value="1" <?php if($field->following == 1) echo 'checked'; ?>>
                  <label>Enable</label>
              </div>
              <div class="radio-box">
                  <input type="radio" name="following" value="0" <?php if($field->following == 0) echo 'checked'; ?>>
                  <label>Disable</label>
              </div>
          </div>
      </div>
      <div class="row cl">
          ...
          <div class="formControls col-6">
              <input type="text" class="input-text" value="<?php echo e($field->msg); ?>" placeholder="" name="msg" >
          </div>
          <div class="col-3"></div>
      </div>
      <div class="row cl">
          ...
          <div class="formControls col-9">
              <textarea name="content" id="content"><?php echo e($field->content); ?></textarea>
          </div>
      </div>
      <div class="row cl">
          <label class="form-label col-3">Hit：</label>
          <div class="formControls col-6">
              <input type="text" class="input-text" value="<?php echo e($field->hit); ?>" placeholder="" name="hit" >
          </div>
          <div class="col-3"></div>
      </div>
    <div class="row cl">
