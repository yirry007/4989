...
@section('content')
<div class="pd-20">
  <form action="<?php echo e(url('/admin/goods')); ?>" method="post" class="form form-horizontal" id="form-member-add">
	...
	<div id="tab-category" class="HuiTab">
		...
		<div class="tabCon">
			...
			<div class="row cl">
				...
				<div class="formControls col-6">
					<input type="text" class="input-text" value="<?php echo e(session('input')['other_name']); ?>" placeholder="" name="other_name" >
				</div>
			</div>
            <div class="row cl">
                <label class="form-label col-3">Video：</label>
                <div class="formControls col-6">
                    <input type="text" class="input-text" value="<?php echo e(session('input')['video']); ?>" placeholder="" name="video" readonly>
                </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-6">
                    <video src="<?php echo e(url('public/'.session('input')['video'])); ?>" width="300" controls="controls" id="video_preview">Browser not supported</video>
                </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-6">
                    <input type="text" class="input-text" value="<?php echo e(session('input')['poster']); ?>" placeholder="" name="poster" readonly>
                </div>
                <div class="formControls col-3">
                    <input id="poster" type="file" multiple="false">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-3">Preview：</label>
                <div class="formControls col-6">
                    <img src="<?php echo e(url('public/'.session('input')['poster'])); ?>" width="240" id="poster_preview" />
                </div>
                <div class="col-3"></div>
            </div>
            <div class="row cl category">
                ...
                <div class="formControls col-6">
                    <span class="select-box">
                        ...
                        <option value="<?php echo e($v->id); ?>" <?php echo session('input')['category_id'] == $v->id ? 'selected' : ''; ?>><?php echo e(str_repeat('◇', 4*$v->level).$v->name); ?></option>
                        <?php endforeach; ?>
                        </select>
                    </span>
                </div>
			...
			<div class="row cl">
				...
				<div class="formControls col-6"> <span class="select-box">
					<select class="select" size="1" name="brand_id">
						<option value="0" <?php if(!session('input')['brand_id']) echo 'selected'; ?>>Please Select Brand</option>
                        <?php foreach($brandData as $v): ?>
						<option value="<?php echo e($v->id) ?>" <?php if(session('input')['brand_id'] == $v->id) echo 'selected'; ?>><?php echo e($v->name) ?></option>
                        <?php endforeach; ?>
					</select>
				</span> </div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-6">
					<input type="text" class="input-text" value="<?php echo e(session('input')['image']); ?>" placeholder="" name="image" readonly>
				</div>
				<div class="formControls col-3">
			...
			<div class="row cl">
				<label class="form-label col-3"><span class="c-red">*</span> <input type="text" class="input-text" style="width: 60px;" value="VIP price" name="price_name" >VIP price：</label>
				<div class="formControls col-6">
					<input type="text" class="input-text" value="<?php echo e(session('input')['price']); ?>" onkeyup="this.value=this.value.replace(/[^\d.]/g, '');" placeholder="" name="price" >
				</div>
				<div class="col-3">
			...
			<div class="row cl">
				<label class="form-label col-3"><span class="c-red">*</span> <input type="text" class="input-text" style="width: 60px;" value="Sale Price" name="org_price_name" >：</label>
				<div class="formControls col-6">
					<input type="text" class="input-text" value="<?php echo e(session('input')['org_price']); ?>" onkeyup="this.value=this.value.replace(/[^\d.]/g, '');" placeholder="" name="org_price" >
				</div>
				<div class="col-3">
			...
			<div class="row cl">
				...
				<div class="formControls col-6">
					<input type="text" class="input-text" value="<?php echo e(session('input')['weight']); ?>" onkeyup="this.value=this.value.replace(/[^\d.]/g, '');" placeholder="" name="weight" >
				</div>
				<div class="col-3">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-6"> <span class="select-box">
					<select class="select" size="1" name="express_id">
						<option value="0" <?php if(!session('input')['express_id']) echo 'selected'; ?>>National</option>
                        <?php foreach($express as $v): ?>
                        <option value="<?php echo e($v->id) ?>" <?php if(session('input')['express_id'] == $v->id) echo 'selected'; ?>><?php echo e($v->province_name) ?></option>
                        <?php endforeach; ?>
					</select>
				</span> </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-6">
                    <input type="text" class="input-text" value="<?php echo e(session('input')['stock']); ?>" onkeyup="this.value=this.value.replace(/\D/g, '');" placeholder="" name="stock">
                </div>
                <div class="col-3">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-6">
                    <input type="text" class="input-text" value="<?php echo e(session('input')['limit_num']); ?>" placeholder="default 1" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" name="limit_num" >
                </div>
            </div>
			<div class="row cl">
				<label class="form-label col-3">Sale Volume：</label>
				<div class="formControls col-6">
					<input type="text" class="input-text" value="<?php echo e(session('input')['sale']); ?>" placeholder="default 0" onkeyup="this.value=this.value.replace(/\D/g, '');" name="sale" >
				</div>
			</div>
			<div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-6 skin-minimal">
                    <div class="radio-box">
                        <input type="radio" name="is_sale" value="1" <?php if(session('input')['is_sale'] === '1') echo 'checked'; ?>>
                        <label>Enable</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" name="is_sale" value="0" <?php if(session('input')['is_sale'] === '0' || session('input')['is_sale'] === NULL) echo 'checked'; ?>>
                        <label>Disable</label>
                    </div>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-6 skin-minimal">
                    <div class="radio-box">
                        <input type="radio" name="is_one" value="1" <?php if(session('input')['is_one'] === '1') echo 'checked'; ?>>
                        <label>Single</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" name="is_one" value="0" <?php if(session('input')['is_one'] === '0' || session('input')['is_one'] === NULL) echo 'checked'; ?>>
                        <label>Multi</label>
                    </div>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-6 skin-minimal">
                    <div class="radio-box">
                        <input type="radio" name="special" value="1" <?php if(session('input')['special'] === '1') echo 'checked'; ?>>
                        <label>Special</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" name="special" value="0" <?php if(session('input')['special'] === '0' || session('input')['special'] === NULL) echo 'checked'; ?>>
                        <label>Normal</label>
                    </div>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-6 skin-minimal">
                    <div class="radio-box">
                        <input type="radio" name="fiveday" value="1" <?php if(session('input')['fiveday'] === '1') echo 'checked'; ?>>
                        <label>Five Day</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" name="fiveday" value="0" <?php if(session('input')['fiveday'] === '0' || session('input')['fiveday'] === NULL) echo 'checked'; ?>>
                        <label>Normal</label>
                    </div>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-6">
                    <input type="text" class="input-text" value="<?php echo session('input')['market_price'] ?: '0.00'; ?>" onkeyup="this.value=this.value.replace(/[^\d\.]/g, '');" placeholder="" name="market_price">
                </div>
                <div class="col-3">
        ...
        <div class="tabCon">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-8">
                    <div id="goods_images">
                        <?php if(session('input')['goods_images']): ?>
                        <?php foreach(session('input')['goods_images'] as $v): ?>
                        <div class="uploaded_img">
                            <input type="hidden" class="good_img" name="goods_images[]" value="<?php echo e($v); ?>" />
                            <img src="<?php echo e(url(explode('@', $v)[0])); ?>" width="90" height="90" />
		...
		<div class="tabCon">
			<div class="row cl">
				...
				<div class="formControls col-8">
					<textarea name="detail" id="detail"><?php echo e(session('input')['detail']); ?></textarea>
				</div>
			</div>
		</div>
	</div>
