...
<div class="pd-20">
  <form action="<?php echo e(url('/admin/bus_ads/'.$field->id)); ?>" method="post" class="form form-horizontal">
          ...
          <div class="formControls col-6">
            <span class="select-box">
                <select class="select" size="1" name="partner_code">
                    ...
                    <option value="<?php echo e($v->code) ?>" <?php if($field->partner_code == $v->code) echo 'selected'; ?>><?php echo e($v->name) ?></option>
                    <?php endforeach; ?>
                </select>
            </span>
          </div>
