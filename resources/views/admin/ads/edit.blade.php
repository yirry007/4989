...
<div class="pd-20">
  <form action="<?php echo e(url('/admin/ads/'.$field->id)); ?>" method="post" class="form form-horizontal">
      ...
      <div class="row cl">
          ...
          <div class="formControls col-6">
              <input type="text" class="input-text" value="<?php echo e($field->url); ?>" placeholder="ex：https://www.baidu.com/" name="url" >
          </div>
      </div>
      <div class="row cl">
